        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0"> Create Project</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('project.index') }}"> Create Project</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form id="jquery-val-form" action="{{ route('project.store') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
